...
//        this.setLocale(l);
    ...
    public void showPanel(boolean t) {
...
//        }
    ...
    void addAllExamples(JMenu menu) {
        String dr = ResourceUtil.loadURLFromResource("examples").getPath();
...
//                openURL("file:///" + dr + sp + "help" + sp + path);
                openURL(ResourceUtil.loadURLFromResource("help/" + path).getPath());
            }
        } else {
            _command = command;
...
//        removeAllDependentDialogs();
    ...
    public void saveProofAsGIF() {
        ...
        String dr1 = DirsUtil.getUserDir();
...
//            out.close();
        ...
        if (endfix.equals("gif")) {
            try {
                ...
                if (CMisc.isDebug())
                    ...
                    JOptionPane.showMessageDialog(this, ee.getMessage(), "Information", JOptionPane.ERROR_MESSAGE);
            }
        } else {
    ...
    public DataOutputStream openOutputFile(String s) {
        ...
        String s1 = DirsUtil.getUserDir();
        String s2 = DirsUtil.getFileSeparator();
...
//        group.add(button);
        ...
        JToggleButton b1 = null;
        {
            ...
            URL imageURL = ResourceUtil.loadURLFromResource(imgLocation);
            Icon co = null;
            if (imageURL != null) {
...
//        button.setBorder(BorderFactory.createEmptyBorder(0,2,0,2));
    ...
    protected JToggleButton makeAButtonWith2ICon(String imageName,
        ...
        imageURL = ResourceUtil.loadURLFromResource(imgLocation);
...
//    }
    ...
    public static URL getResourceURL(String path) {
        return ResourceUtil.loadURLFromResource(path);
    }

    public static void createAndShowGUI() { // APPLET ONLY.
        ...
        if (!CMisc.isApplet()) {
            ...
            exp.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
            exp.pack();

            Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
            exp.setSize(1200, 900);

            exp.setLocation((int) (screenSize.getWidth() - 1200) / 2,
    ...
    public static void setLookAndFeel() {
        ...
        try {
            ...
            if (f != null && f.length() != 0 && !f.equals("Default")) {
                ...
                for (UIManager.LookAndFeelInfo lookAndFeelInfo : ff) {
                    if (lookAndFeelInfo.getName().equals(f)) {
