...
public class CMisc {
    ...
    public static void setHomeDirectory(URL l) {
        homedir = l;
    }

    public static URL getHomeDirectory() {
        return homedir;
    }
    ...
    public static void eprint(Component t, String s) {
    ...
    public static void initFont() {   // rebuild the font.
